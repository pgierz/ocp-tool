...
def interpolate_co2_to_icmgg(co2_grib_file, icmgg_iniua_file, output_file=None, variable_name='an', co2_var_name='co2', verbose=False, use_dask=False, n_workers=None):
    ...
    try:
        ...
        if use_dask:
            ...
            with LocalCluster(n_workers=n_workers, threads_per_worker=1) as cluster, Client(cluster):
                if verbose:
        ...
        if use_dask:
            ...
            for target_level in icmgg_levels:
                ...
                target_shape[0] * target_shape[1] if len(target_shape) > 1 else target_shape[0]
        ...
        try:
            ...
            with open(output_file, 'wb') as out_file:
                ...
                try:
                    ...
                    if verbose:
                        print("Created base GRIB2 template message")
